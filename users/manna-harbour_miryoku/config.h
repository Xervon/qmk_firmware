...
// Thumb Combos
#define MIRYOKU_KLUDGE_THUMBCOMBOS_COMBO_COUNT 0
#if defined (MIRYOKU_KLUDGE_THUMBCOMBOS)
  #undef MIRYOKU_KLUDGE_THUMBCOMBOS_COMBO_COUNT
  #define MIRYOKU_KLUDGE_THUMBCOMBOS_COMBO_COUNT 8
#endif

// Custom Combos
#if !defined (MIRYOKU_CUSTOM_COMBO_COUNT)
  #define MIRYOKU_CUSTOM_COMBO_COUNT 0
#endif

// Combos
#if defined (MIRYOKU_KLUDGE_THUMBCOMBOS) || MIRYOKU_CUSTOM_COMBO_COUNT > 0
  #define COMBO_TERM 200
  #define EXTRA_SHORT_COMBOS
  #define COMBO_COUNT \
    MIRYOKU_KLUDGE_THUMBCOMBOS_COMBO_COUNT + \
